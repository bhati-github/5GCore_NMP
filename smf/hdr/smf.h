...
struct smf_config {
    ...
    ip_addr_t  my_Nsmf_addr;
    int        my_Nsmf_socket_id;
...
typedef struct smf_config   smf_config_t;

extern smf_config_t  g__smf_config;
...
extern uint8_t  g__Nsmf_send_msg_buffer[MSG_BUFFER_LEN];
extern uint8_t  g__Nsmf_rcvd_msg_buffer[MSG_BUFFER_LEN];
