...
#define MSG_TYPE__INITIAL_UE_MSG_REGISTRATION_REQ  3
#define MSG_TYPE__DNLINK_NAS_TRANSPORT_AUTH_REQ    4
#define MSG_TYPE__UPLINK_NAS_TRANSPORT_AUTH_RESP   5
#define MSG_TYPE__DNLINK_NAS_TRANSPORT_REGISTRATION_ACCEPT   6
#define MSG_TYPE__UPLINK_NAS_TRANSPORT_REGISTRATION_COMPLETE 7
#define MSG_TYPE__UPLINK_NAS_TRANSPORT_PDU_SESSION_ESTABLISH_REQ    8
#define MSG_TYPE__DNLINK_NAS_TRANSPORT_PDU_SESSION_ESTABLISH_ACCEPT 9
#define MSG_TYPE__DNLINK_NAS_TRANSPORT_PDU_SESSION_ESTABLISH_REJECT 10
#define MSG_TYPE__PDU_SESSION_RESOURCE_SETUP_RESP 11

#define MSG_TYPE__SESSION_CREATE_REQUEST  21
#define MSG_TYPE__SESSION_CREATE_RESPONSE 22

#define MSG_TYPE__SESSION_MODIFY_REQUEST     23
#define MSG_TYPE__SESSION_MODIFY_RESPONSE    24

#define MSG_TYPE__SESSION_DELETE_REQUEST     25
#define MSG_TYPE__SESSION_DELETE_RESPONSE    26

#define MSG_TYPE__BEARER_SETUP_REQUEST 27
